...
Blockly.Blocks['authenticate_google_spreadsheet'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs:
        credential_file_path - The path to the credential file. Example: "C:\\Users\\User\\Desktop\\credentials.json"
        ____________________________________________
        Returns:
        Status - Whether the operation was successful or not.
...
Blockly.Blocks['excel_get_dataframe_from_google_spreadsheet'] = {
    init: function () {
        ...
        spreadsheet_url - The URL of the spreadsheet. Example: "https://docs.google.com/spreadsheets/d/...../edit?usp=sharing"

        sheet_name - The name of the sheet. Example: "Sheet1"
        ____________________________________________
        Returns:
        Status - Whether the operation was successful or not.
...
Blockly.Blocks['excel_copy_range_from_sheet_new'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs:
        input_filepath - The filepath of the file. Example: "C:\\Users\\user\\Desktop\\file.xlsx"

        input_sheetname - The name of the sheet. Example: "Sheet1"

        start_col - The column number of the starting cell of the range. Example: For first column, start_col = 0.

        start_row - The row number of the starting cell of the range. Example: For first row, start_row = 0.

        end_col - The column number of the ending cell of the range. Example: For fifth column, end_col = 4.

        end_row - The row number of the ending cell of the range. Example: For fifth row, end_row = 4.
        ____________________________________________
        Returns:
        Status - Whether the operation was successful or not.
...
Blockly.Blocks['excel_get_single_cell_new'] = {
    init: function () {
        ...
        column_name - The name of the column. Example: "Age"
        
        cell_number - The cell number of the cell starting from 0. Example: If the required data is in fourth cell, then enter as 3.
        ____________________________________________
        Returns:
        Status - Whether the operation was successful or not.
...
Blockly.Blocks['excel_paste_range_to_sheet_new'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs:
        input_filepath - The filepath of the excel file. Example: "C:\\Users\\user\\Desktop\\file.xlsx"

        input_sheetname - The name of the sheet in the excel file. Example: "Sheet1"

        start_col - The column number of the start of the range. Example: If the start of the range is in column 3, then enter as 2.

        start_row - The row number of the start of the range. Example: If the start of the range is in row 2, then enter as 1.
...
Blockly.Blocks['excel_set_single_cell_new'] = {
    init: function () {
        ...
        column_name - The name of the column to be modified. Example: "column_name"

        cell_number - The number of the cell to be modified. Example: If the cell is in row 2 of given column, then enter as 1.
...
Blockly.Blocks['excel_drop_columns_new'] = {
    init: function () {
        ...
        cols - The columns to be dropped. Example:  Single column name "A" or a list of column names ["A", "B", "C"]
        ____________________________________________
        Returns:
        Status - Whether the operation was successful or not.
        Data - The modified dataframe.
...
Blockly.Blocks['convert_excel_to_colored_html'] = {
    init: function () {
        ...
        Output Folder (OPT) - The folder path of the html file. Example: "C:\\Users\\User\\Desktop\\"
         
        Output Filename (OPT) - The filename of the html file. Example: "file.html"
        ____________________________________________
        Returns:
        Status - Whether the operation was successful or not.
        ____________________________________________
...
Blockly.Blocks['api_request'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs:
        URL - The URL of the API. Example: "https://www.google.com"
...
Blockly.Blocks['file_get_json_details'] = {
    init: function () {
        ...
        Section - The key of the data to be retrieved. Example: "name"
        ____________________________________________
        Returns:
        Status - Whether the operation was successful or not.
        ____________________________________________
...
Blockly.Blocks['key_press'] = {
    init: function () {
        ...
        Key 1 - The first key to press. Example: "a"
...
Blockly.Blocks['key_write_enter'] = {
    init: function () {
        ...
        Key - The key to press at the end of the text. Example: "e"
        ____________________________________________
        Returns:
        Status - Whether the operation was successful or not.
        ____________________________________________
...
Blockly.Blocks['mail_send_gmail_with_app_password'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs:
        Gmail Username - The username of the gmail account. Example: "support@pybots.ai" 

        Gmail App Password - The app password of the gmail account. Example: "123456789"
...
Blockly.Blocks['print_ap'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs:
        Variable - The variable value to print to the user. Example: "Hello World"
        ____________________________________________
        `);
