Blockly.Blocks["chrome_instance_v2"] = {
  init: function () {
    ...
    Inputs:
    ChromeDriver - The path to the ChromeDriver executable.
    SeleniumDriver - The path to the SeleniumDriver executable.
    DummyBrowser - A boolean value indicating whether to use a dummy browser.
    Incognito - A boolean value indicating whether to use an incognito browser.
    ____________________________________________
    Outputs:
    None
    ____________________________________________
...
Blockly.Blocks["chrome_download_path"] = {
  init: function () {
    ...
    ____________________________________________
    Inputs:
    Path - The path to set the download path to.
    ____________________________________________
    Outputs:
...
Blockly.Blocks["chrome_write"] = {
  init: function () {
    ...
    ____________________________________________
    Inputs:
    Text - The text to write in the field.
    Field Name - The name of the field to write in.
    ____________________________________________
    Outputs:
...
Blockly.Blocks['chrome_mouse_click'] = {
  init: function () {
    ...
    ____________________________________________
    Inputs:
    Click Type - The type of click (Single, Double, Right, Hover) to perform.
    Value Type - The element (Text, Button, Link, Checkbox, Radio, Image, XPath) to click on.
    ____________________________________________
    Outputs:
...
Blockly.Blocks["chrome_check_exists"] = {
  init: function () {
    ...
    ____________________________________________
    Inputs:
    Value Type - The element (Text, Button, Link, Image, ListItem) to check if exists.
    ____________________________________________
    Outputs:
...
Blockly.Blocks["chrome_wait_until"] = {
  init: function () {
    ...
    ____________________________________________
    Inputs:
    Value Type - The element (Text, Button, Link, Image, ListItem) to wait until appears.
    ____________________________________________
    Outputs:
    The element would be checked if exists.
    ____________________________________________
...
Blockly.Blocks["chrome_key_press"] = {
  init: function () {
    ...
    ____________________________________________
    Inputs:
    Press Key - The key(s) to be pressed.
    ____________________________________________
    Outputs:
...
Blockly.Blocks["chrome_mouse_hover"] = {
  init: function () {
    ...
    ____________________________________________
    Inputs:
    User Visible Text Element - The text element to be hovered.
    ____________________________________________
    Outputs:
...
Blockly.Blocks["chrome_set_waiting_time"] = {
  init: function () {
    ...
    ____________________________________________
    Inputs:
    Waiting Time - The waiting time for the chrome browser page.
    ____________________________________________
    Outputs:
...
Blockly.Blocks["chrome_scroll"] = {
  init: function () {
    ...
    ____________________________________________
    Inputs:
    Direction - The direction (Down, Up, Left, Right) to be scrolled.
    Weight - The weight of the scroll.
    ____________________________________________
    Outputs:
...
Blockly.Blocks["get_text"] = {
  init: function () {
    ...
    ____________________________________________
    Inputs:
    Element XPath - The XPath of the element to be clicked.
    ____________________________________________
    Outputs:
...
Blockly.Blocks["get_element_image"] = {
  init: function () {
    ...
    Inputs:
    Element XPath - The XPath of the element to be clicked.
    Image Name - The name of the image to be saved.
    Base64 - The option to save the image as base64.
    ____________________________________________
    Outputs:
...
Blockly.Blocks["get_value_relatively"] = {
  init: function () {
    ...
    ____________________________________________
    Inputs:
    Element Type - The type of the element to be clicked.
    Above - The text element above the desired element.
    Below - The text element below the desired element.
    To Left of - The text element to the left of the desired element.
    To Right of - The text element to the right of the desired element.
    ____________________________________________
    Outputs:
