Blockly.Blocks['excel_tabular_data_from_website'] = {
    init: function () {
        ...
        Inputs :
        website_url - URL of the website as a string.
        table_number - Table number to be extracted as a number starting from 1.
        ____________________________________________
        Returns :
...
Blockly.Blocks['df_from_string'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs :
        df_string - String containing the data.
        word_delimeter - Word separator used to separate words in the string.
        line_delimeter - Line separator used to separate lines in the string.
        column_names - List of column names.
        ____________________________________________
        Returns :
        Status - Whether the operation was successful or not.
...
Blockly.Blocks['df_extract_sub_df'] = {
    init: function () {
        ...
        Inputs :
        df - Dataframe object.
        row_start - Row number to start extracting from (number starts from 0).
        row_end - Row number to end extracting from (number starts from 0).
        column_start - Column number to start extracting from (number starts from 0).
        column_end - Column number to end extracting from (number starts from 0).
        ____________________________________________
        Returns :
        Status - Whether the operation was successful or not.
        Data - Dataframe object containing the data.
...
Blockly.Blocks['set_value_in_df'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs :
        df - Dataframe object to be modified.
        row_number - Row number to set the value in.
        column_number - Column number to set the value in.
        value - Value to be set in the dataframe.
        ____________________________________________
        Returns :
        Status - Whether the operation was successful or not.
        Data - Dataframe object containing the data.
...
Blockly.Blocks['get_value_in_df'] = {
    init: function () {
        ...
        Inputs :
        df - Dataframe object to be modified.
        row_number - Row number to get the value from.
        column_number - Column number to get the value from.
        ____________________________________________
        Returns :
        Status - Whether the operation was successful or not.
...
Blockly.Blocks['screen_scrape_extract_table'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs :
        switch_to_window - Window to switch to for scraping.
        after_this_word - Word to be searched after.
        before_this_word - Word to be searched before.
        ____________________________________________
        Returns :
        Status - Whether the operation was successful or not.
...
Blockly.Blocks['string_extract_substring'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs :
        string - String to be extracted from.
        start_word - Word to be searched after.
        end_word - Word to be searched before.
        ____________________________________________
        Returns :
        Status - Whether the operation was successful or not.
...
Blockly.Blocks['add_datetime'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs :
        input_date - Date to be added to.
        value - Value (days/hours/minutes/weeks/months) to be added.
        ____________________________________________
        Returns :
        Date - Modified date.   
        ____________________________________________
...
Blockly.Blocks['subtract_datetime'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs :
        input_date - Date to be subtracted from.
        value - Value (days/hours/minutes/weeks/months) to be subtracted.
        ____________________________________________
        Returns :
        Date - Modified date.
        ____________________________________________
