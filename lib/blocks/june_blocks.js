Blockly.Blocks['excel_tabular_data_from_website'] = {
    init: function () {
        ...
        Inputs :
        website_url - URL of the website as a string. Example : "https://www.google.com"

        table_number - Table number to be extracted as a number starting from 1. Example : 3
        ____________________________________________
        Returns :
...
Blockly.Blocks['df_from_list'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs :
        list_of_lists - List of lists. Example : [[1,2,3],[4,5,6]]

        column_names - List of column names. Example : ["A","B","C"]
        ____________________________________________
        Returns :
        Status - Whether the operation was successful or not.
        Data - Dataframe object containing the data.
...
Blockly.Blocks['df_from_string'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs :
        df_string - String containing the data. Example : "1,2,3\n4,5,6"

        word_delimeter - Word separator used to separate words in the string. Example : ","

        line_delimeter - Line separator used to separate lines in the string. Example : "\n"
...
Blockly.Blocks['df_extract_sub_df'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs :
        df - Dataframe object. Example: "df" (created in earlier block)

        row_start - Row number to start extracting from (number starts from 0). Example : 0

        row_end - Row number to end extracting from (number starts from 0). Example : 1

        column_start - Column number to start extracting from (number starts from 0). Example : 0

        column_end - Column number to end extracting from (number starts from 0). Example : 1
        ____________________________________________
        Returns :
        Status - Whether the operation was successful or not.
        Data - Dataframe object containing the data.
...
Blockly.Blocks['set_value_in_df'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs :
        df - Dataframe object to be modified. Example: "df" (created in earlier block)

        row_number - Row number to set the value in. Example : 1

        column_number - Column number to set the value in. Example : 1
...
Blockly.Blocks['get_value_in_df'] = {
    init: function () {
        ...
        row_number - Row number to get the value from. Example : 1

        column_number - Column number to get the value from. Example : 1
        ____________________________________________
        Returns :
        Status - Whether the operation was successful or not.
...
Blockly.Blocks['screen_scrape_extract_table'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs :
        switch_to_window - Window to switch to for scraping. Example: "Google"

        after_this_word - Word to be searched after. Example: "Next"

        before_this_word - Word to be searched before. Example: "Date"
        ____________________________________________
        Returns :
        Status - Whether the operation was successful or not.
...
Blockly.Blocks['string_extract_substring'] = {
    init: function () {
        ...
        start_word - Word to be searched after. Example: "Hello"

        end_word - Word to be searched before. Example: "World"
        ____________________________________________
        Returns :
        Status - Whether the operation was successful or not.
...
Blockly.Blocks['add_datetime'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs : 
        input_date - Date to be added to. Example: "2020-01-01"
...
Blockly.Blocks['subtract_datetime'] = {
    init: function () {
        ...
        ____________________________________________
        Inputs :
        input_date - Date to be subtracted from. Example: "2020-01-01"
